...
public class DichVuFrame extends javax.swing.JFrame {
    ...
    public DichVuFrame(TaiKhoanDangNhapDTO tkdn) {
        this.tkdn = tkdn;
        initComponents();
        kiemTraVaiTro();
    ...
    private void initComponents() {
        ...
        ThoiLuong.setBackground(new java.awt.Color(204, 204, 255));
        ThoiLuong.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        ThoiLuong.setForeground(new java.awt.Color(0, 0, 0));
        ThoiLuong.setHorizontalAlignment(javax.swing.JTextField.CENTER);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(ThoiLuong, javax.swing.GroupLayout.DEFAULT_SIZE, 102, Short.MAX_VALUE))
                        .addGap(190, 190, 190))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(Ten, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 290, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(ThoiLuong, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(12, 12, 12)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        tbDichVu.setBackground(new java.awt.Color(204, 204, 204));
    ...
    private void displayRecord(int index) {
        DichVuDTO dichVu = dichVuList.get(index);
        Ten.setText(dichVu.getTenDichVu());
        MoTa.setText(dichVu.getMoTa());
        ThoiLuong.setText(formatThoiLuong(dichVu.getThoiLuong()));
        Gia.setText(formatGia(dichVu.getGia(), decimalFormat));
    }
    ...
    private void BackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BackActionPerformed
        if (currentIndex > 0) {
            currentIndex--;
            tbDichVu.setRowSelectionInterval(currentIndex, currentIndex);
            displayRecord(currentIndex);
        }
    }//GEN-LAST:event_BackActionPerformed

    private void NextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NextActionPerformed
        if (currentIndex < dichVuList.size() - 1) {
            currentIndex++;
            tbDichVu.setRowSelectionInterval(currentIndex, currentIndex);
            displayRecord(currentIndex);
        }
    ...
    private void tbDichVuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbDichVuMouseClicked
        ...
        if (selectedRow != -1) {
            int index = selectedRow; // Lấy trực tiếp chỉ số dòng được chọn
            currentIndex = index;
            displayRecord(currentIndex);
        }
    ...
    private boolean validateData() {
        String tenDichVu = Ten.getText();
        String moTa = MoTa.getText();
        String thoiLuongText = ThoiLuong.getText().replaceAll("[^\\d]", "");
        String giaText = Gia.getText().replaceAll("[^\\d.]", "");

        if (tenDichVu.isEmpty() || moTa.isEmpty() || thoiLuongText.isEmpty() || giaText.isEmpty()) {
        ...
        try {
            ...
            if (thoiLuong <= 0) {
                JOptionPane.showMessageDialog(this, "Thời lượng phải là một số nguyên dương.");
                return false;
            }
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        if (validateData()) {
            ...
            DichVuDTO dichVu = new DichVuDTO(tenDichVu, moTa, thoiLuong, gia);
            DichVuDAO dichVuDAO = new DichVuDAO();
            boolean success = dichVuDAO.addDichVu(dichVu);
            ...
            if (success) {
                ...
                dfm.addRow(new Object[]{
                    dichVu.getTenDichVu(),
                    dichVu.getMoTa(),
                    formatThoiLuong(dichVu.getThoiLuong()),
                    formatGia(dichVu.getGia(), decimalFormat)
                }
                );
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        if (selectedRow != -1) {
            if (validateData()) {
                int maDichVu = (int) tbDichVu.getValueAt(selectedRow, 0);
                int confirm = JOptionPane.showConfirmDialog(this, "Bạn có chắc chắn muốn xóa dịch vụ này không?", "Xác nhận xóa", JOptionPane.YES_NO_OPTION);

                if (confirm == JOptionPane.YES_OPTION) {
                    DichVuDAO dichVuDAO = new DichVuDAO();
                    boolean success = dichVuDAO.deleteDichVu(maDichVu);
                    if (success) {
                        JOptionPane.showMessageDialog(this, "Xóa dịch vụ thành công !");
                        clearText();
                        dichVuList.remove(selectedRow);
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        ...
        if (selectedRow != -1 && validateData()) {
            ...
            DichVuDTO dichVu = new DichVuDTO(maDichVu, tenDichVu, moTa, thoiLuong, gia);
            DichVuDAO dichVuDAO = new DichVuDAO();
            boolean success = dichVuDAO.updateDichVu(dichVu);
            if (success) {
                JOptionPane.showMessageDialog(this, "Cập nhật dịch vụ thành công !");
                clearText();
                dichVuList.set(selectedRow, dichVu);
                dfm.setValueAt(dichVu.getTenDichVu(), selectedRow, 1);
                dfm.setValueAt(dichVu.getMoTa(), selectedRow, 2);
                dfm.setValueAt(formatThoiLuong(dichVu.getThoiLuong()), selectedRow, 3);
                dfm.setValueAt(formatGia(dichVu.getGia(), decimalFormat), selectedRow, 4);
            } else {
                JOptionPane.showMessageDialog(this, "Lỗi khi cập nhật dịch vụ !");
            }
        } else {
    ...
    //=========================================================================================
    private String formatThoiLuong(int thoiLuong) {
        return thoiLuong + "m";
    }
    ...
    private void initTable() {
        ...
        dfm.setColumnIdentifiers(new String[]{"Mã Dịch Vụ", "Tên Dịch Vụ", "Mô Tả", "Thời Lượng", "Giá", "Ngày Tạo"});
        tbDichVu.setModel(dfm);
        getData();
    ...
    private void getData() {
        ...
        for (DichVuDTO d : dichVuList) {
            dfm.addRow(new Object[]{
                d.getMaDichVu(),
                d.getTenDichVu(),
                d.getMoTa(),
                formatThoiLuong(d.getThoiLuong()),
                formatGia(d.getGia(), decimalFormat),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DichVuFrame.class
